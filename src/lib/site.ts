import { PUBLIC_GA_MEASUREMENT_ID, PUBLIC_SITE_URL } from '$env/static/public';

export const site = {
	url: PUBLIC_SITE_URL || 'https://curl-cleaner.rohitpatil.me',
	name: 'Curl Cleaner',
